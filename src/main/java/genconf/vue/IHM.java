...
//     }
    ...
    public void afficher InfosSession(Session session){

    }
    public void afficherLibelleSession(Session session){

    }
    public void afficherListeParametresModificationTypeCommunication(){
    ...
    public void confirmerAjoutCommunicationASession(Communication communication, Session session){

    }
    public void confirmerCreationConf(Conference c){

    }
    
    public void ConfirmerSuppressionCommunicationASession(Communication communication, Session session){
    ...
    public void demanderSiModifierCommunication(){
